...
const Hero = () => {
  return (
    <div className="absolute top-0 left-0 w-full overflow-x-hidden">
      ...
      <div className="absolute top-0 w-[150%] h-[600px] rounded-bl-full -rotate-16 -translate-y-25 md:-translate-y-50 lg:-translate-y-75 -translate-x-20 md:-translate-x-30 lg:-translate-x-30 bg-[#60A3D9]/50"></div>
      <Intro />
    </div>
  );
};
